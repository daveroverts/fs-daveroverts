...
The current RDF plugin can't be used with TrackAudio. Luckily, there is an alternative that does support it. This plugin also takes over the role of the Audio for Vatsim EuroScope Bridge.
